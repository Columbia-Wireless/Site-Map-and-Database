      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
          ...
          <button
            ...
            disabled={googleLoading || msLoading || loading}
            style={{
              width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px',
              padding: '11px', borderRadius: '8px',
              border: '1px solid #e2e8f0', background: 'white',
              fontSize: '14px', fontWeight: 500, color: '#0f172a',
              cursor: googleLoading ? 'not-allowed' : 'pointer', transition: 'background 0.15s',
            }}
          >
            {googleLoading
          ...
          <button
            ...
            disabled={msLoading || googleLoading || loading}
            style={{
              width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px',
              padding: '11px', borderRadius: '8px',
              border: '1px solid #e2e8f0', background: 'white',
              fontSize: '14px', fontWeight: 500, color: '#0f172a',
              cursor: msLoading ? 'not-allowed' : 'pointer', transition: 'background 0.15s',
            }}
          >
            {msLoading
              ? <Loader2 size={16} style={{ animation: 'spin 1s linear infinite' }} />
